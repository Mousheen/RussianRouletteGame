...
namespace RussionRouletteGame
{
    public partial class MainGame : Form
    {
        ...
        int chanceCount = 1; //creates a counter to keep track of how many times the fire button has been pressed
        int checkCount = 0; //creates a count to check if the "Shoot Away" checkbox is ticked. Game only allows one option to shoot away.
        ...
        int spinChambers; //stores what chamber the bullet is in
        int bulletCounter = 0;

        private void bulletLoad() //defining the function
        {
        ...
        private void barrelSpin() //Defining the function
        {
        ...
        {
            barrelSpin();
            spinChambers = rnd.Next(1, 7); //Creates a random number between 1 & 6 and stores it in spinChambers
            ...
            bulletCounter = 0; //Bullet counter to use later with if statment
        ...
        private void btnFire_Click(object sender, EventArgs e)
        {
            ...
            if (bulletCounter == 1) //Creates a if statment for the bullet images dissapearing from screen.
            {
            ...
            if (spinChambers == chanceCount) //If the player fires and the bullet is in the chamber than they loose.
            {
            ...
            if (checkCount == 1) //Disables the checkbox after it has been checked once. 
            {
                cbPointAway.Checked = false;
                cbPointAway.Visible = false;
                cbPointAway.Enabled = false;
        ...
        {
            chanceCount = 1; //I've only resetted buttons and counters but not the score so the game knows to track all the scores. 
            checkCount = 0;
